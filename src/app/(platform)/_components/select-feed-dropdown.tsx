...
export default function SelectFeedDropdown() {
  ...
  return (
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      ...
      >
        <button className="bg-barcelona-elevated-background border-barcelona-primary-outline relative flex h-[24px] min-h-0 w-[24px] min-w-0 shrink-0 basis-auto cursor-pointer touch-manipulation flex-row items-center justify-center rounded-full border-[0.5px] transition-transform duration-200 outline-none select-none hover:scale-[1.05] active:scale-[0.96]">

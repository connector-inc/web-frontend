...
export default function SidebarDesktop() {
  return (
    <div className="bg-barcelona-side-navigation-background fixed top-0 left-0 z-10 hidden h-screen min-h-[480px] w-[76px] flex-col items-center justify-between overflow-visible backdrop-blur-[28.5px] md:flex">
      <div className="shrink-0 touch-manipulation justify-center overflow-hidden py-[14px] transition-transform duration-200 [transition-timing-function:ease-in-out] select-none hover:scale-[1.05] active:scale-[0.96]">
        <Link href={'/'}>

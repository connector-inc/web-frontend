...
export default function HeaderMobile() {
  ...
  return (
    <header
      className="bg-barcelona-header-background fixed inset-0 top-0 left-0 z-10 h-fit w-full max-w-full items-center backdrop-blur-[28.5px] transition-transform duration-200 ease-[cubic-bezier(0,0,0,1)] md:hidden"
      style={{ transform: `translateY(${translateY}px)` }}
    >
      <div className="grid h-[60px] max-w-full grid-cols-[1fr_32px_1fr] grid-rows-[1fr] items-center">
        <div className="col-start-2 m-auto shrink-0 touch-manipulation justify-center overflow-hidden transition-transform duration-200 [transition-timing-function:ease-in-out] select-none hover:scale-[1.05] active:scale-[0.96]">
          <Link href={'/'}>
        ...
        <div className="col col-start-3 row-start-1 mr-[13px] ml-auto flex flex-col items-center">
          <Link
            download
            href={'#'}
